    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid flex-column">
            ...
            <div class="w-100 d-flex align-items-center">
                <a class="navbar-brand" href="facultyhome"><i class="bi bi-mortarboard"></i>SLMS</a>
                ...
                <div class="collapse navbar-collapse" id="facultyNavbar">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="facultyprofile">
                                <i class="bi bi-person"></i>Profile
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="uploadmaterial">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link logout-link" href="facultylogout">
